<template>
	<view style="font-size: 14px;line-height: 26px;padding: 32upx;background: #FFFFFF;" class="home1">
		...
		<view style="font-size: 16px;font-weight: bold">1. 适用范围</view>
		...
		<view style="font-size: 16px;font-weight: bold">2. 信息使用</view>
		<view>
		...
		<view style="font-size: 16px;font-weight: bold">3. 信息披露</view>
		...
		<view style="font-size: 16px;font-weight: bold">4. 信息存储和交换</view>

		<view>
			本应用收集的有关您的信息和资料将保存在本应用及（或）其关联公司的服务器上，这些信息和资料可能传送至您所在国家、地区或本应用收集信息和资料所在地的境外并在境外被访问、存储和展示。
		</view>

		<view style="font-size: 16px;font-weight: bold">5. Cookie的使用</view>
		...
		<view style="font-size: 16px;font-weight: bold">6. 信息安全</view>
		...
		<view style="font-size: 16px;font-weight: bold">7.本隐私政策的更改</view>
		...
		<view style="margin-top:8px;text-align: center" @click="toLogout">西安省钱兄网络科技有限公司版本所有</view>
	</view>
</template>
